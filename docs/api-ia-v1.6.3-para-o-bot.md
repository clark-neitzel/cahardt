# API de Consulta do CA-Hardt para a IA (v1.6.3) — guia autocontido para o time do bot
...
como autenticar, todos os endpoints (histórico completo da v1.0 até a v1.6.3), o formato do objeto
...
```json
{
  "meta": { "versaoApi": "1.6.3", "avisos": [], "geradoEm": "2026-09-16T12:00:00.000Z" },
...
## 3. Tabela de endpoints (histórico completo v1.0 → v1.6.3)
...
## 13. Avisos ativos (histórico até 2026-09-16, v1.6.3)
