...
5. **Desfazer** (ícone de seta) volta qualquer conciliado/ignorado para pendente.
...
- **Vários pagamentos num PIX só**: o banco mostra um lançamento único e o app tem várias baixas — concilie com uma delas e ignore ou trate o restante manualmente (v1 não faz conciliação 1-para-N).
