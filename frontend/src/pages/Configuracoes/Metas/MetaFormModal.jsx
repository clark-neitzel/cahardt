...
const MetaFormModal = ({ isOpen, onClose, metaData, vendedores, mesAtualStr }) => {
    ...
    // Arrays para renderizar a grid (ajustando espaços para começar no dia da semana certo)
    const monthDays = [];
    ...
    useEffect(() => {
        if (metaData) {
            ...
            // Garantir parse correto se vier string do banco (Json field no Prisma)
    ...
    const selecionarDiasUteis = () => {
        const diasUteis = monthDays
            .filter(d => d.day() !== 0 && d.day() !== 6) // Remove domingos (0) e sábados (6)
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post(`${API_URL}/metas`, formData, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
            });
            toast.success("Meta gravada com sucesso!");
            onClose(true); // Indica que salvou
        } catch (error) {
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 overflow-y-auto">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    disabled={!!metaData} // Nao deixa trocar o vendedor na edicao
                                    required
                                >
                        ...
                        {/* Calendário Interativo para seleção dos dias de atuação */}
                        <div className="border rounded-lg p-4 bg-gray-50">
                            <div className="flex justify-between items-center mb-4">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Marque os dias exatos que o vendedor trabalhará neste mês. O sistema dividirá a Meta Total por estes dias.</p>
                                </div>
                ...
                <div className="p-4 border-t bg-gray-50 flex justify-end gap-3 rounded-b-lg">
                    ...
                    <button
                        type="button" // Change to type=button and trigger form submit
