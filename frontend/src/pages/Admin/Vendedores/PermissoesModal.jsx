...
const BOOL_INDEX = [
    ...
    { sec: 'financeiro', path: 'Pode_Ver_Pendencias', nome: 'Central de Pendências', desc: 'Tela /pendencias: painel agregado do que está esperando um clique (pedidos p/ aprovar, NF-e, caixas, notas recebidas, produção, tarefas). Quem já tem admin ou Fluxo de Caixa/DRE já enxerga sem precisar desta', kw: 'pendencias central painel resumo aprovar nota fiscal caixa tarefa producao' },
