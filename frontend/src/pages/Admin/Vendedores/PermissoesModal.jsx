...
const BOOL_INDEX = [
    ...
    { sec: 'financeiro', path: 'Pode_Acessar_Contabilidade', nome: 'Contabilidade (consulta)', desc: 'Área Administração → Contabilidade: relatórios para o contador (títulos, recebimentos, NF, banco da baixa). Somente leitura e exportação — nenhum botão de baixa/edição', kw: 'contabilidade contador relatorio fiscal exportar csv consulta escritorio' },
