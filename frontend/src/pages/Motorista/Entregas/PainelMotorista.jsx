...
import { Truck, MapPin, CheckCircle, Package, Clock, HelpCircle, Navigation } from 'lucide-react';
            ...
            <div className="px-4 space-y-4">
                {loading ? (
                    ...
                    entregas.map((entrega) => (
                        <div key={entrega.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transform transition-all active:scale-[0.98]">
                            <div className="p-4 border-b border-gray-100">
                                <div className="flex justify-between items-start">
                                    <div className="pr-4">
                                        <h3 className="text-lg font-bold text-gray-900 leading-tight mb-1">{entrega.cliente?.NomeFantasia}</h3>
                            ...
                            {abaAtiva === 'concluidas' && (
                                <div className="p-3 flex flex-col space-y-2 bg-gray-50">
                                    <div className="flex justify-between items-center">
                                        ...
                                        {entrega.statusEntrega === 'ENTREGUE_PARCIAL' && <span className="text-xs font-bold text-amber-700 bg-amber-100 px-2 rounded">⚠️ PARCIAL</span>}
